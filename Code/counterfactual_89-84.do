*counterfactual 89-84 (1989 is 0 and 1984 is 1)
...
if (gender=="men"){
	if (B=="Yes"){
		fh=fopen("${results}89-84/qwages","r")
		qwages=fgetmatrix(fh)
		fclose(fh)
		fh=fopen("${results}89-84/qhours","r")
		...
		fh=fopen("${results}89-84/qwages","a")
		fputmatrix(fh,qwages)
		fclose(fh)
		fh=fopen("${results}89-84/qhours","a")
		fputmatrix(fh,qhours)
		fclose(fh)
		fh=fopen("${results}89-84/pwages","a")
		fputmatrix(fh,pwages)
		fclose(fh)
		fh=fopen("${results}89-84/phours","a")
...
if (gender=="women"){
	if (B=="Yes"){
		fh=fopen("${results}w89-84/qwages","r")
		qwages=fgetmatrix(fh)
		fclose(fh)
		fh=fopen("${results}w89-84/qhours","r")
		qhours=fgetmatrix(fh)
		fclose(fh)
	}
	else{
		...
		pwages= mm_quantile(wages,weights,(.1,.2,.3,.4,.5,.6,.7,.8,.9))'
		phours= mm_quantile(hours,weights,(.1,.2,.3,.4,.5,.6,.7,.8,.9))'
		fh=fopen("${results}w89-84/qwages","a")
		fputmatrix(fh,qwages)
		fclose(fh)
		fh=fopen("${results}w89-84/qhours","a")
		fputmatrix(fh,qhours)
		fclose(fh)
		fh=fopen("${results}w89-84/pwages","a")
		fputmatrix(fh,pwages)
		fclose(fh)
		fh=fopen("${results}w89-84/phours","a")
		fputmatrix(fh,phours)
		fclose(fh)
	}
}
...
forvalues i=1/50{
	...
	mata fh=fopen("${results}89-84/boot`i'","a")
...
fh=fopen("${results}w89-84/wdiff","a")
fputmatrix(fh,wdiff)
fclose(fh)
end
...
forvalues i=1/50{
	...
	mata fh=fopen("${results}w89-84/w_boot`i'","a")
	mata fputmatrix(fh,temp)
	mata fclose(fh)
	dis `i'
	restore, preserve
